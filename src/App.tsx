...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 md:p-10 lg:p-14 overflow-x-hidden">
      ...
      <footer className={`fixed bottom-0 left-0 right-0 pb-3 pt-1.5 text-center text-cyan-400/80 font-instrument italic text-xs sm:text-sm md:text-base bg-black/80 backdrop-blur-sm transform transition-all duration-1000 delay-[2000ms] ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
        <div className="flex flex-col items-center gap-1.5 sm:gap-2">
          <span className="text-cyan-300 text-sm sm:text-base md:text-lg font-medium tracking-wide">Made by AK</span>
